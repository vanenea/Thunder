...
public class WeatherServiceImpl implements WeatherService {
	...
	public int sendMail() {
		...
		String text = "您好" + toMail.substring(toMail.indexOf(",") + 1) + "。" + data.getLocation() + "明天["
				+ data.getDate() + "]天气预报,白天" + data.getCond_txt_d() + ",晚间" + data.getCond_txt_n() + ",最高温度"
				+ data.getTmp_max() + ",最低温度" + data.getTmp_min() + ",降水概率" + data.getPop() + ",请注意天气变化！";
